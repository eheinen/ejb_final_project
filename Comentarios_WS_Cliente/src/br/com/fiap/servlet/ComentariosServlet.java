...
public class ComentariosServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			ComentarioPortType comentarioSerice = new ComentarioPortTypeProxy();
			...
			comentarioSerice.add(comentarios);
			request.setAttribute("comentarios", comentarioSerice.getAll());
		}catch(Exception e){
			e.printStackTrace();
		}
		request.getRequestDispatcher("comentarios.jsp");
	}

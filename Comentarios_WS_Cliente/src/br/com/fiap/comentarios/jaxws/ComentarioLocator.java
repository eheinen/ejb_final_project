...
public class ComentarioLocator extends org.apache.axis.client.Service implements br.com.fiap.comentarios.jaxws.Comentario {

    public ComentarioLocator() {
    }


    public ComentarioLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public ComentarioLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for ComentarioPort
    private java.lang.String ComentarioPort_address = "http://localhost:8080/Comentarios_EJB/Comentario/ComentariosBean";
    ...
    public br.com.fiap.comentarios.jaxws.ComentarioPortType getComentarioPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.fiap.comentarios.jaxws.ComentarioSoapBindingStub _stub = new br.com.fiap.comentarios.jaxws.ComentarioSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.fiap.comentarios.jaxws.ComentarioPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.fiap.comentarios.jaxws.ComentarioSoapBindingStub _stub = new br.com.fiap.comentarios.jaxws.ComentarioSoapBindingStub(new java.net.URL(ComentarioPort_address), this);
                _stub.setPortName(getComentarioPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jaxws.comentarios.fiap.com.br", "Comentario");
    }
